...
glm::mat4 camera::isometric_model() noexcept {
    const glm::mat4 x_rotation = glm::rotate(glm::mat4{1.f}, glm::radians(35.264f), {1.f, 0.f, 0.f});
    const glm::mat4 y_rotation = glm::rotate(glm::mat4{1.f}, glm::radians(-45.f), {0.f, 1.f, 0.f});
